...
export class SummaryRepository {
	...
	async addSummarySignature(
		...
		try {
			...
			// 	signature_params.front_document_image = await pdfDoc.embedPng(imagen_front_document_path)
			...
			// 	signature_params.behind_document_image = await pdfDoc.embedPng(imagen_behind_document_path)
	...
	// async addSummarySignatureWithDocIdentity(
	// 	path_file: string,
	// 	signature_params: SignatureParams,
	// ) {
	...
	// 		let front_document_image = undefined
	// 		let behind_document_image = undefined

	// 		if (signature_params.doc_identidad) {

	// 			if (signature_params.path_imagen_front_document) {
	// 				const imagen_front_document_path = await fs.readFile(signature_params.path_imagen_front_document)
	// 				front_document_image = await pdfDoc.embedJpg(imagen_front_document_path)

	// 				front_document_image.scale(0.5)
	// 			}

	// 			if (signature_params.path_imagen_behind_document) {
	// 				const imagen_behind_document_path = await fs.readFile(signature_params.path_imagen_behind_document)
	// 				behind_document_image = await pdfDoc.embedJpg(imagen_behind_document_path)

	// 				behind_document_image.scale(0.5)
	// 			}
	...
	// 			newPage.drawText("Documento de Identidad del Firmante", {
	// 				x: 25,
	// 				y: newheight,
	// 				size: 12,
	// 				font: helvicaBoldFont,
	...
	// 			if (front_document_image) {

	// 				newPage.drawImage(front_document_image, {
	// 					x: 25 + 25 + 10,
	// 					y: newheight,
	// 					width: 150,
	// 					height: 150,
	...
	// 			if (behind_document_image) {

	// 				newPage.drawImage(behind_document_image, {
	// 					x: 25 + 25 + 10 + 150 + 10,
	// 					y: newheight,
	// 					width: 150,
	// 					height: 150,
